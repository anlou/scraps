<ul class="collapsible popout" data-collapsible="accordion">
    <div class="link">
        <a href="https://habrahabr.ru/post/321924/">habrahabr</a>
    </div>
    <li>
        ...
        <div class="collapsible-body">
            ...
            <div class="card-panel">
                ...
                <b>"og:type"</b> — указывает тип страницы (статья, новость, видео, категория и т. д.), можно использовать по умолчанию "article".<br>
                <b>"og:title"</b> — указывает заголовок статьи.<br>
                <b>"og:description"</b> — указывает краткое описание, которое выводится при формировании превью ссылки.<br>
                <b>"og:url"</b> — ссылка на страницу сайта.<br>
                <b>"og:image"</b> — ссылка на картинку, которая будет отображаться в посте.<br>
                <b>"og:site_name"</b> — название сайта.<br>
            </div>
        </div>
    </li>
</ul>
